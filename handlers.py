...
async def menu_exam_variants(callback: types.CallbackQuery) -> None:
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text='Вариант 1', callback_data='variant_1'),
             InlineKeyboardButton(text='Вариант 2', callback_data='variant_2')],

            [InlineKeyboardButton(text='Вариант 3', callback_data='variant_3'),
             InlineKeyboardButton(text='Вариант 4', callback_data='variant_4')],
